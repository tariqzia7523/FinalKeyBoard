...
import com.german.keyboard.app.free.language.InputAttributes;
...
import com.german.keyboard.app.free.language.utils.ResourceUtils;
import com.german.keyboard.app.free.language.utils.RunInLocale;
...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_KEYBOARD_BG_COLOR_RESOURCE= "pref_bg_color_resource";
    ...
    public static final String SCREEN_LANGUAGE = "screen_languge";
    ...
    public static void setSelectedLaguage(final SharedPreferences prefs,String code) {
        prefs.edit().putString(SCREEN_LANGUAGE, code).apply();
    }

    public static String getSelectedLanguage(final SharedPreferences prefs) {
        return  prefs.getString(SCREEN_LANGUAGE, "en");
    }
    ...
    public static void setBgColor(final SharedPreferences prefs,int id ) {
        prefs.edit().putInt(PREF_KEYBOARD_BG_IMAGE_TYPE, 3).apply();
        prefs.edit().putInt(PREF_KEYBOARD_BG_COLOR_RESOURCE, id).apply();
    }
    public static int getBgColor(final SharedPreferences prefs ) {
        return prefs.getInt(PREF_KEYBOARD_BG_COLOR_RESOURCE, Color.parseColor("#c2c2c2"));
    }
